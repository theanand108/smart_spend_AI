...
def test_user_correction_path_commits_without_reclassification():
...
def test_corrected_category_becomes_future_entity_history_evidence():
    ...
    history = [
        {"merchant_name": "COLLEGE BOOK SHOP", "category": "Education", "amount": 900, "note": "textbook purchase"},
        {"merchant_name": "COLLEGE BOOK SHOP", "category": "Education", "amount": 1100, "note": "notebook and stationery"},
        {"merchant_name": "COLLEGE BOOK SHOP", "category": "Education", "amount": 950, "note": "college books"},
        {"merchant_name": "COLLEGE BOOK SHOP", "category": "Education", "amount": 1000, "note": "stationery for semester"},
    ]
